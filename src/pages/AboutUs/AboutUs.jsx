                    ...
                    <Col xs={11} lg={6} className="mx-auto">
                        <div className="mission text-center bg-green-100 mb-5 overflow-hidden mx-auto" style={{borderRadius: "4px"}}>
                            <div className="mission-content-container">
                                ...
                                <img src={Polygon} alt="polygon-mission" className="polygon-mission" />
                            </div>
                        </div>
                    </Col>
                    <Col xs={11} lg={6} className="mx-auto">   
                ...
                <Container className="py-4 py-lg-5">
                    <Row>
                        <Col xs={12} lg={5} className="order-lg-2 offset-lg-1 mt-2 mt-lg-5">
                            <h3 className="deep-blue-100 text-center culture pt-lg-5 px-md-0" style={{fontWeight: "800"}}>
                                The <span className="green-100">KodeCamp</span> Culture
                            </h3>
                            <p className="deep-blue-100 text-center d-none d-lg-block pt-2 px-lg-1 px-xl-4" id="text-below-culture" style={{fontWeight: "500"}}>
                                These are the values that we hold dear. These culture and ethics have shaped us into one of the best tech 
                                learning institutions in the industry.
                            </p>
                        </Col>
                        ...
                        <Col xs={12} lg={6} className="order-lg-1 mt-5">
                            <Row>
                                <Col xs={12} className="">
                                    <div className="bg-deep-blue-100 square-div mx-auto" style={{borderRadius: '4px'}}>
                                        <p className="white-100 text-center pb-3 square-div-text" style={{fontWeight: "700"}}>
                                            L
                                        </p>
                                    </div>
                                    <p className="deep-blue-100 text-center text-below-square-div pt-2" style={{fontWeight: '700'}}>
                                        LEADERSHIP
                                    </p>
                                </Col>

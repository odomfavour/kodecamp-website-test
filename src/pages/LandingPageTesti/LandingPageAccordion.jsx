    ...
    <>
        <Accordion defaultActiveKey="0" flush>
            <Accordion.Item eventKey="0" className='mb-4 blue100acc'>
                <Accordion.Header className=''>Andriod Development</Accordion.Header>
                <Accordion.Body>
            ...
            <Accordion.Item eventKey="1" className='mb-4 deepblue100acc'>
                <Accordion.Header className='landing-fs-24 fw-semibold'>Product Design</Accordion.Header>
                <Accordion.Body>
            ...
            <Accordion.Item eventKey="2" className='mb-4 green100acc'>
                <Accordion.Header className='landing-fs-24 fw-semibold'>FrontEnd/BackEnd Development</Accordion.Header>
                <Accordion.Body>
            ...
            <Accordion.Item eventKey="3" className='black100acc'>
                <Accordion.Header className='landing-fs-24 fw-semibold '>Product Management</Accordion.Header>
                <Accordion.Body>

  ...
  return (
    <>
        <div className='landingpageacc'>
            <Accordion  >
                <Accordion.Item eventKey="0" className='mb-4 deepblue100acc' flush key={id} >
                ...
                <Accordion.Item eventKey="2" className='mb-4 deepblue100acc'>
                ...
                <Accordion.Item eventKey="3" className='deepblue100acc'>
